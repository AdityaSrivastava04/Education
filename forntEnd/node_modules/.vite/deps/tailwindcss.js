...
var g2 = (_a = class {
  ...
  resolveWith(e, r, i = []) {
    ...
    let s2 = {};
    for (let u2 of i) {
      let a = `${t}${u2}`, o = this.values.get(a);
      o && (o.options & 1 ? s2[u2] = o.value : s2[u2] = __privateMethod(this, _g_instances, t_fn).call(this, a));
    }
  ...
  for (let i of r) {
    ...
    if (!this.values.has(t)) if (e !== null && e.includes(".")) {
      if (t = `${i}-${e.replaceAll(".", "_")}`, !this.values.has(t)) continue;
    } else continue;
    if (!h2(t, i)) return t;
  }
  return null;
}, t_fn = function(e) {
  return this.values.has(e) ? `var(${f2(__privateMethod(this, _g_instances, i_fn).call(this, e))})` : null;
}, _a);
  ...
  for (let f3 = 0; f3 < t.length; f3++) {
    ...
    if (p3 === ce) a += t.slice(f3, f3 + 2), f3 += 1;
      ...
      for (let h3 = f3 + 1; h3 < t.length; h3++) if (d2 = t.charCodeAt(h3), d2 === ce) h3 += 1;
        ...
        if (d2 === Ve && t.charCodeAt(h3 + 1) === Q2) throw new Error(`Unterminated string: ${t.slice(g3, h3 + 1) + String.fromCharCode(p3)}`);
        if (d2 === Q2) throw new Error(`Unterminated string: ${t.slice(g3, h3) + String.fromCharCode(p3)}`);
      }
      a += t.slice(g3, f3 + 1);
    } else {
      if ((p3 === de2 || p3 === Q2 || p3 === Ne) && (d2 = t.charCodeAt(f3 + 1)) && (d2 === de2 || d2 === Q2 || d2 === Ne)) continue;
      if (p3 === Q2) {
        if (a.length === 0) continue;
        d2 = a.charCodeAt(a.length - 1), d2 !== de2 && d2 !== Q2 && d2 !== Ne && (a += " ");
      } else if (p3 === ft && t.charCodeAt(f3 + 1) === ft && a.length === 0) {
        let g3 = "", h3 = f3, y2 = -1;
        for (let v2 = f3 + 2; v2 < t.length; v2++) if (d2 = t.charCodeAt(v2), d2 === ce) v2 += 1;
        else if (d2 === Ce && t.charCodeAt(v2 + 1) === $e) {
          for (let x = v2 + 2; x < t.length; x++) if (d2 = t.charCodeAt(x), d2 === ce) x += 1;
          else if (d2 === $e && t.charCodeAt(x + 1) === Ce) {
            v2 = x + 1;
            break;
          }
        } else if (y2 === -1 && d2 === br) y2 = a.length + v2 - h3;
        else if (d2 === Ve && g3.length === 0) {
          a += t.slice(h3, v2), f3 = v2;
          break;
        } else if (d2 === Me) g3 += ")";
        else if (d2 === kr) g3 += "]";
        else if (d2 === st) g3 += "}";
        else if ((d2 === Ue || t.length - 1 === v2) && g3.length === 0) {
          f3 = v2 - 1, a += t.slice(h3, v2);
          break;
        } else (d2 === ut || d2 === xr || d2 === Ue) && g3.length > 0 && t[v2] === g3[g3.length - 1] && (g3 = g3.slice(0, -1));
        let w2 = ze(a, y2);
        if (!w2) throw new Error("Invalid custom property, expected a value");
        o ? o.nodes.push(w2) : r.push(w2), a = "";
      } else if (p3 === Ve && a.charCodeAt(0) === Ie) s2 = pe2(a), o ? o.nodes.push(s2) : r.push(s2), a = "", s2 = null;
      else if (p3 === Ve && c[c.length - 1] !== ")") {
        let g3 = ze(a);
        if (!g3) throw a.length === 0 ? new Error("Unexpected semicolon") : new Error(`Invalid declaration: \`${a.trim()}\``);
        o ? o.nodes.push(g3) : r.push(g3), a = "";
      } else if (p3 === st && c[c.length - 1] !== ")") c += "}", s2 = M2(a.trim()), o && o.nodes.push(s2), e.push(o), o = s2, a = "", s2 = null;
      else if (p3 === Ue && c[c.length - 1] !== ")") {
        if (c === "") throw new Error("Missing opening {");
        if (c = c.slice(0, -1), a.length > 0) if (a.charCodeAt(0) === Ie) s2 = pe2(a), o ? o.nodes.push(s2) : r.push(s2), a = "", s2 = null;
        else {
          let h3 = a.indexOf(":");
          if (o) {
            let y2 = ze(a, h3);
            if (!y2) throw new Error(`Invalid declaration: \`${a.trim()}\``);
            o.nodes.push(y2);
          }
        }
        let g3 = e.pop() ?? null;
        ...
        if (a.length === 0 && (p3 === de2 || p3 === Q2 || p3 === Ne)) continue;
        a += String.fromCharCode(p3);
      }
    }
  }
  if (a.charCodeAt(0) === Ie && r.push(pe2(a)), c.length > 0 && o) {
...
function M2(t, r = []) {
  return t.charCodeAt(0) === Cr ? pe2(t, r) : F2(t, r);
}
...
function Se(t, r, n = [], e = {}) {
  for (let o = 0; o < t.length; o++) {
    let s2 = t[o], a = n[n.length - 1] ?? null;
    if (s2.kind === "rule" || s2.kind === "at-rule") n.push(s2), Se(s2.nodes, r, n, e), n.pop();
    else if (s2.kind === "context") {
      Se(s2.nodes, r, n, { ...e, ...s2.context });
      continue;
    }
    n.push(s2), r(s2, { parent: a, context: e, path: n, replaceWith(c) {
...
function te2(t) {
  ...
  function e(s2, a, c = 0) {
    if (s2.kind === "declaration") {
      ...
      let f3 = [];
      e(d2, f3, c + 1), f3.length > 0 && a.push(...f3);
    }
    else {
      let d2 = { ...s2, nodes: [] };
      for (let f3 of s2.nodes) e(f3, d2.nodes, c + 1);
      d2.nodes.length > 0 && a.push(d2);
    }
    else if (s2.kind === "at-rule" && s2.name === "@property" && c === 0) {
      ...
      let d2 = { ...s2, nodes: [] };
      for (let f3 of s2.nodes) e(f3, d2.nodes, c + 1);
      (d2.nodes.length > 0 || d2.name === "@layer" || d2.name === "@charset" || d2.name === "@custom-media" || d2.name === "@namespace" || d2.name === "@import") && a.push(d2);
      ...
      for (let d2 of s2.nodes) e(d2, a, c);
...
`;
      ...
      s2 += `${a}${e.selector} {
`;
      for (let c of e.nodes) s2 += r(c, o + 1);
      s2 += `${a}}
`;
...
`);
  ...
  for (let a = 0; a < t.length; a++) {
    ...
    switch (c) {
      ...
      case wt: {
        ...
        let d2 = a, f3 = a + 1;
        for (; f3 < t.length && (s2 = t.charCodeAt(f3), !(s2 !== ct && s2 !== dt && s2 !== pt && s2 !== gt && s2 !== mt && s2 !== ht && s2 !== vt && s2 !== yt && s2 !== wt)); f3++) ;
        a = f3 - 1;
        let p3 = Vr(t.slice(d2, f3));
      ...
      case Sr: {
        let d2 = a;
        for (let f3 = a + 1; f3 < t.length; f3++) if (s2 = t.charCodeAt(f3), s2 === Nr) f3 += 1;
        else if (s2 === c) {
          a = f3;
          break;
        }
  ...
  return o.length > 0 && r.push(Be(o)), r;
}
function Y2(t) {
  if (t.indexOf("(") === -1) return ge2(t);
  let r = L2(t);
  return We(r), t = W2(r), t = ie(t), t;
}
function ge2(t) {
  let r = "";
  ...
  for (let r of t) switch (r.kind) {
    case "function": {
      ...
      if (r.value === "var" || r.value.endsWith("_var") || r.value === "theme" || r.value.endsWith("_theme")) {
        r.value = ge2(r.value);
        for (let n = 0; n < r.nodes.length; n++) n == 0 && r.nodes[n].kind === "word" || We([r.nodes[n]]);
        break;
      }
      r.value = ge2(r.value), We(r.nodes);
      break;
    }
    case "separator":
    case "word": {
...
function* At(t, r) {
  ...
  let [a, c = null, d2] = u(e, "/");
  if (d2) return;
  let f3 = c === null ? null : qe(c);
  if (c !== null && f3 === null) return;
  if (a[0] === "[") {
    if (a[a.length - 1] !== "]") return;
    let g3 = a.charCodeAt(1);
    if (g3 !== bt && !(g3 >= kt && g3 <= xt)) return;
    a = a.slice(1, -1);
    let h3 = a.indexOf(":");
  ...
  if (a[a.length - 1] === "]") {
    ...
    let h3 = a.slice(0, g3);
    if (!r.utilities.has(h3, "functional")) return;
    let y2 = a.slice(g3 + 2, -1), w2 = u(y2, ":"), v2 = null;
    if (w2.length === 2 && (v2 = w2[0], y2 = w2[1]), y2[0] !== "-" && y2[1] !== "-") return;
    p3 = [[h3, v2 === null ? `[var(${y2})]` : `[${v2}:var(${y2})]`]];
  } else p3 = $t(a, (g3) => r.utilities.has(g3, "functional"));
  for (let [g3, h3] of p3) {
    ...
    }
    {
      ...
      if (w2 !== -1) {
        ...
        let x = Y2(h3.slice(w2 + 1, -1)), T2 = "";
        for (let N2 = 0; N2 < x.length; N2++) {
          let R2 = x.charCodeAt(N2);
          if (R2 === Pr) {
            T2 = x.slice(0, N2), x = x.slice(N2 + 1);
            break;
          }
          if (!(R2 === bt || R2 >= kt && R2 <= xt)) break;
        }
        if (x.length === 0 || x.trim().length === 0) continue;
        y2.value = { kind: "arbitrary", dataType: T2 || null, value: x };
      } else {
        let x = c === null || ((_a2 = y2.modifier) == null ? void 0 : _a2.kind) === "arbitrary" ? null : `${h3}/${c}`;
...
function Ct(t, r) {
  ...
  }
  {
    let [n, e = null, o] = u(t, "/");
    if (o) return null;
    let s2 = $t(n, (a) => r.variants.has(a));
    for (let [a, c] of s2) switch (r.variants.kind(a)) {
      case "static":
        return c !== null || e !== null ? null : { kind: "static", root: a };
      case "functional": {
        let d2 = e === null ? null : qe(e);
        if (e !== null && d2 === null) return null;
        if (c === null) return { kind: "functional", root: a, modifier: d2, value: null };
        if (c[c.length - 1] === "]") {
          if (c[0] !== "[") continue;
          let f3 = Y2(c.slice(1, -1));
          return f3.length === 0 || f3.trim().length === 0 ? null : { kind: "functional", root: a, modifier: d2, value: { kind: "arbitrary", value: f3 } };
        }
        if (c[c.length - 1] === ")") {
          if (c[0] !== "(") continue;
          let f3 = Y2(c.slice(1, -1));
          return f3.length === 0 || f3.trim().length === 0 || f3[0] !== "-" && f3[1] !== "-" ? null : { kind: "functional", root: a, modifier: d2, value: { kind: "arbitrary", value: `var(${f3})` } };
        }
        return { kind: "functional", root: a, modifier: d2, value: { kind: "named", value: c } };
      }
      case "compound": {
        if (c === null) return null;
        let d2 = r.parseVariant(c);
        if (d2 === null || !r.variants.compoundsWith(a, d2)) return null;
        let f3 = e === null ? null : qe(e);
...
function re2(t, r, n) {
  if (t === r) return 0;
  let e = t.indexOf("("), o = r.indexOf("("), s2 = e === -1 ? t.replace(/[\d.]+/g, "") : t.slice(0, e), a = o === -1 ? r.replace(/[\d.]+/g, "") : r.slice(0, o), c = (s2 === a ? 0 : s2 < a ? -1 : 1) || (n === "asc" ? parseInt(t) - parseInt(r) : parseInt(r) - parseInt(t));
...
var Or = /* @__PURE__ */ new Set(["inset", "inherit", "initial", "revert", "unset"]);
var Vt = /^-?(\d+|\.\d+)(.*?)$/g;
function ne2(t, r) {
  return u(t, ",").map((e) => {
    e = e.trim();
    let o = u(e, " ").filter((f3) => f3.trim() !== ""), s2 = null, a = null, c = null;
    for (let f3 of o) Or.has(f3) || (Vt.test(f3) ? (a === null ? a = f3 : c === null && (c = f3), Vt.lastIndex = 0) : s2 === null && (s2 = f3));
...
function B2(t, r, n) {
  ...
  return e ? G2(t, e) : de(r.value) ? G2(t, `${r.value}%`) : null;
}
function q2(t, r, n) {
  let e = null;
  ...
  return e ? B2(e, t.modifier, r) : null;
}
function Tt(t) {
  let r = new Je();
  function n(i, u2) {
    ...
    r.suggest(i, () => {
      ...
      for (let b2 of u2()) {
        ...
        let V2 = [...b2.values ?? [], ...m(b2.valueThemeKeys ?? [])], K2 = [...b2.modifiers ?? [], ...m(b2.modifierThemeKeys ?? [])];
        b2.hasDefaultValue && V2.unshift(null), k2.push({ supportsNegative: b2.supportsNegative, values: V2, modifiers: K2 });
      }
      return k2;
    });
  }
    ...
    function m({ negative: k2 }) {
      return (b2) => {
        ...
        if (b2.value) if (b2.value.kind === "arbitrary") {
          ...
          if (V2 = t.resolve(b2.value.fraction ?? b2.value.value, u2.themeKeys ?? []), V2 === null && u2.supportsFractions && b2.value.fraction) {
            let [K2, C2] = u(b2.value.fraction, "/");
            if (!p(K2) || !p(C2)) return;
            V2 = `calc(${b2.value.fraction} * 100%)`;
          }
          if (V2 === null && k2 && u2.handleNegativeBareValue) {
            if (V2 = u2.handleNegativeBareValue(b2.value), !(V2 == null ? void 0 : V2.includes("/")) && b2.modifier) return;
            if (V2 !== null) return u2.handle(V2);
          }
          if (V2 === null && u2.handleBareValue && (V2 = u2.handleBareValue(b2.value), !(V2 == null ? void 0 : V2.includes("/")) && b2.modifier)) return;
        }
        else {
          if (b2.modifier) return;
          V2 = u2.defaultValue !== void 0 ? u2.defaultValue : t.resolve(null, u2.themeKeys ?? []);
        }
        if (V2 !== null) return u2.handle(k2 ? `calc(${V2} * -1)` : V2);
      };
    }
  ...
  function s2(i, u2) {
    r.functional(i, (m) => {
      if (!m.value) return;
      let k2 = null;
      if (m.value.kind === "arbitrary" ? (k2 = m.value.value, k2 = B2(k2, m.modifier, t)) : k2 = q2(m, t, u2.themeKeys), k2 !== null) return u2.handle(k2);
  ...
  function a(i, u2, m, { supportsNegative: k2 = false, supportsFractions: b2 = false } = {}) {
    k2 && r.static(`-${i}-px`, () => m("-1px")), r.static(`${i}-px`, () => m("1px")), o(i, { themeKeys: u2, supportsFractions: b2, supportsNegative: k2, defaultValue: null, handleBareValue: ({ value: V2 }) => {
      let K2 = t.resolve(null, ["--spacing"]);
      return !K2 || !ue(V2) ? null : `calc(${K2} * ${V2})`;
    }, handleNegativeBareValue: ({ value: V2 }) => {
      let K2 = t.resolve(null, ["--spacing"]);
      return !K2 || !ue(V2) ? null : `calc(${K2} * -${V2})`;
    }, handle: m }), n(i, () => [{ values: t.get(["--spacing"]) ? ["0", "0.5", "1", "1.5", "2", "2.5", "3", "3.5", "4", "5", "6", "7", "8", "9", "10", "11", "12", "14", "16", "20", "24", "28", "32", "36", "40", "44", "48", "52", "56", "60", "64", "72", "80", "96"] : [], supportsNegative: k2, valueThemeKeys: u2 }]);
  }
  ...
  e("w-screen", [["width", "100vw"]]), e("min-w-screen", [["min-width", "100vw"]]), e("max-w-screen", [["max-width", "100vw"]]), e("h-screen", [["height", "100vh"]]), e("min-h-screen", [["min-height", "100vh"]]), e("max-h-screen", [["max-height", "100vh"]]), e("max-w-none", [["max-width", "none"]]), e("max-h-none", [["max-height", "none"]]), a("size", ["--size", "--spacing"], (i) => [l3("--tw-sort", "size"), l3("width", i), l3("height", i)], { supportsFractions: true });
  ...
  let f3 = () => D2([$2("--tw-scale-x", "1"), $2("--tw-scale-y", "1"), $2("--tw-scale-z", "1")]);
  ...
  {
    let i = ["var(--tw-rotate-x)", "var(--tw-rotate-y)", "var(--tw-rotate-z)", "var(--tw-skew-x)", "var(--tw-skew-y)"].join(" "), u2 = () => D2([$2("--tw-rotate-x", "rotateX(0)"), $2("--tw-rotate-y", "rotateY(0)"), $2("--tw-rotate-z", "rotateZ(0)"), $2("--tw-skew-x", "skewX(0)"), $2("--tw-skew-y", "skewY(0)")]);
  ...
  let h3 = () => D2([$2("--tw-pan-x"), $2("--tw-pan-y"), $2("--tw-pinch-zoom")]);
  ...
  let y2 = () => D2([$2("--tw-scroll-snap-strictness", "proximity", "*")]);
  ...
  e("border-solid", [["--tw-border-style", "solid"], ["border-style", "solid"]]), e("border-dashed", [["--tw-border-style", "dashed"], ["border-style", "dashed"]]), e("border-dotted", [["--tw-border-style", "dotted"], ["border-style", "dotted"]]), e("border-double", [["--tw-border-style", "double"], ["border-style", "double"]]), e("border-hidden", [["--tw-border-style", "hidden"], ["border-style", "hidden"]]), e("border-none", [["--tw-border-style", "none"], ["border-style", "none"]]);
  {
    let u2 = function(m, k2) {
      r.functional(m, (b2) => {
        if (!b2.value) {
          if (b2.modifier) return;
          let V2 = t.get(["--default-border-width"]) ?? "1px", K2 = k2.width(V2);
          return K2 ? [i(), ...K2] : void 0;
        }
        if (b2.value.kind === "arbitrary") {
          let V2 = b2.value.value;
          switch (b2.value.dataType ?? pe(V2, ["color", "line-width", "length"])) {
            case "line-width":
            case "length": {
              if (b2.modifier) return;
              let C2 = k2.width(V2);
            ...
            default:
              return V2 = B2(V2, b2.modifier, t), V2 === null ? void 0 : k2.color(V2);
          }
        }
        {
          let V2 = q2(b2, t, ["--border-color", "--color"]);
          if (V2) return k2.color(V2);
        }
        {
          if (b2.modifier) return;
          let V2 = t.resolve(b2.value.value, ["--border-width"]);
          if (V2) {
            let K2 = k2.width(V2);
            return K2 ? [i(), ...K2] : void 0;
          }
  ...
  e("bg-auto", [["background-size", "auto"]]), e("bg-cover", [["background-size", "cover"]]), e("bg-contain", [["background-size", "contain"]]), e("bg-fixed", [["background-attachment", "fixed"]]), e("bg-local", [["background-attachment", "local"]]), e("bg-scroll", [["background-attachment", "scroll"]]), e("bg-center", [["background-position", "center"]]), e("bg-top", [["background-position", "top"]]), e("bg-right-top", [["background-position", "right top"]]), e("bg-right", [["background-position", "right"]]), e("bg-right-bottom", [["background-position", "right bottom"]]), e("bg-bottom", [["background-position", "bottom"]]), e("bg-left-bottom", [["background-position", "left bottom"]]), e("bg-left", [["background-position", "left"]]), e("bg-left-top", [["background-position", "left top"]]), e("bg-repeat", [["background-repeat", "repeat"]]), e("bg-no-repeat", [["background-repeat", "no-repeat"]]), e("bg-repeat-x", [["background-repeat", "repeat-x"]]), e("bg-repeat-y", [["background-repeat", "repeat-y"]]), e("bg-repeat-round", [["background-repeat", "round"]]), e("bg-repeat-space", [["background-repeat", "space"]]), e("bg-none", [["background-image", "none"]]);
  {
    let m = function(V2) {
      let K2 = "in oklab";
      if ((V2 == null ? void 0 : V2.kind) === "named") switch (V2.value) {
        case "longer":
        case "shorter":
        case "increasing":
        case "decreasing":
          K2 = `in oklch ${V2.value} hue`;
          break;
        default:
          K2 = `in ${V2.value}`;
      }
      else (V2 == null ? void 0 : V2.kind) === "arbitrary" && (K2 = V2.value);
      return K2;
    }, k2 = function({ negative: V2 }) {
      return (K2) => {
        if (!K2.value) return;
        if (K2.value.kind === "arbitrary") {
          ...
          switch (K2.value.dataType ?? pe(U2, ["angle"])) {
            case "angle":
              return U2 = V2 ? `calc(${U2} * -1)` : `${U2}`, [l3("--tw-gradient-position", U2), l3("background-image", `linear-gradient(var(--tw-gradient-stops,${U2}))`)];
            default:
              return V2 ? void 0 : [l3("--tw-gradient-position", U2), l3("background-image", `linear-gradient(var(--tw-gradient-stops,${U2}))`)];
          }
        }
        let C2 = K2.value.value;
        if (!V2 && u2.has(C2)) C2 = u2.get(C2);
        else if (p(C2)) C2 = V2 ? `calc(${C2}deg * -1)` : `${C2}deg`;
        else return;
        let A2 = m(K2.modifier);
        return [l3("--tw-gradient-position", `${C2} ${A2}`), l3("background-image", "linear-gradient(var(--tw-gradient-stops))")];
      };
    }, b2 = function({ negative: V2 }) {
      return (K2) => {
        var _a2;
        ...
        if (p(A2)) return A2 = V2 ? `calc(${A2} * -1)` : `${A2}deg`, [l3("--tw-gradient-position", `from ${A2} ${C2}`), l3("background-image", "conic-gradient(var(--tw-gradient-stops))")];
      };
    };
    var T2 = m, N2 = k2, R2 = b2;
    ...
    r.functional("-bg-linear", k2({ negative: true })), r.functional("bg-linear", k2({ negative: false })), n("bg-linear", () => [{ values: [...u2.keys()], modifiers: i }, { values: ["0", "30", "60", "90", "120", "150", "180", "210", "240", "270", "300", "330"], supportsNegative: true, modifiers: i }]), r.functional("-bg-conic", b2({ negative: true })), r.functional("bg-conic", b2({ negative: false })), n("bg-conic", () => [{ hasDefaultValue: true, modifiers: i }, { values: ["0", "30", "60", "90", "120", "150", "180", "210", "240", "270", "300", "330"], supportsNegative: true, modifiers: i }]), r.functional("bg-radial", (V2) => {
      if (!V2.value) {
        let K2 = m(V2.modifier);
    ...
    if (i.value) {
      if (i.value.kind === "arbitrary") {
        ...
        switch (i.value.dataType ?? pe(u2, ["image", "color", "percentage", "position", "bg-size", "length", "url"])) {
          ...
          default:
            return u2 = B2(u2, i.modifier, t), u2 === null ? void 0 : [l3("background-color", u2)];
        }
      }
      {
      ...
      if (m.value) {
        if (m.value.kind === "arbitrary") {
          ...
          switch (m.value.dataType ?? pe(k2, ["color", "length", "percentage"])) {
            ...
            default:
              return k2 = B2(k2, m.modifier, t), k2 === null ? void 0 : u2.color(k2);
          }
        }
        {
  ...
  v2("from", { color: (i) => [w2(), l3("--tw-sort", "--tw-gradient-from"), l3("--tw-gradient-from", i), l3("--tw-gradient-stops", "var(--tw-gradient-via-stops, var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position))")], position: (i) => [w2(), l3("--tw-gradient-from-position", i)] }), e("via-none", [["--tw-gradient-via-stops", "initial"]]), v2("via", { color: (i) => [w2(), l3("--tw-sort", "--tw-gradient-via"), l3("--tw-gradient-via", i), l3("--tw-gradient-via-stops", "var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-via) var(--tw-gradient-via-position), var(--tw-gradient-to) var(--tw-gradient-to-position)"), l3("--tw-gradient-stops", "var(--tw-gradient-via-stops)")], position: (i) => [w2(), l3("--tw-gradient-via-position", i)] }), v2("to", { color: (i) => [w2(), l3("--tw-sort", "--tw-gradient-to"), l3("--tw-gradient-to", i), l3("--tw-gradient-stops", "var(--tw-gradient-via-stops, var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position))")], position: (i) => [w2(), l3("--tw-gradient-to-position", i)] }), e("box-decoration-slice", [["-webkit-box-decoration-break", "slice"], ["box-decoration-break", "slice"]]), e("box-decoration-clone", [["-webkit-box-decoration-break", "clone"], ["box-decoration-break", "clone"]]), e("bg-clip-text", [["background-clip", "text"]]), e("bg-clip-border", [["background-clip", "border-box"]]), e("bg-clip-padding", [["background-clip", "padding-box"]]), e("bg-clip-content", [["background-clip", "content-box"]]), e("bg-origin-border", [["background-origin", "border-box"]]), e("bg-origin-padding", [["background-origin", "padding-box"]]), e("bg-origin-content", [["background-origin", "content-box"]]);
  ...
  e("mix-blend-plus-darker", [["mix-blend-mode", "plus-darker"]]), e("mix-blend-plus-lighter", [["mix-blend-mode", "plus-lighter"]]), e("fill-none", [["fill", "none"]]), r.functional("fill", (i) => {
    if (!i.value) return;
    if (i.value.kind === "arbitrary") {
      let m = B2(i.value.value, i.modifier, t);
    ...
    if (i.value) {
      if (i.value.kind === "arbitrary") {
        ...
        switch (i.value.dataType ?? pe(u2, ["color", "number", "length", "percentage"])) {
          ...
          default:
            return u2 = B2(i.value.value, i.modifier, t), u2 === null ? void 0 : [l3("stroke", u2)];
        }
      }
      {
    ...
    if (!(!i.value || i.modifier)) {
      if (i.value.kind === "arbitrary") {
        ...
        switch (i.value.dataType ?? pe(u2, ["number", "generic-name", "family-name"])) {
          ...
          default:
            return [D2([$2("--tw-font-weight")]), l3("--tw-font-weight", u2), l3("font-weight", u2)];
        }
      }
      {
    ...
    if (i.value) {
      if (i.value.kind === "arbitrary") {
        ...
        switch (i.value.dataType ?? pe(u2, ["color", "length", "percentage"])) {
          ...
          default:
            return u2 = B2(u2, i.modifier, t), u2 === null ? void 0 : [l3("text-decoration-color", u2)];
        }
      }
      {
  ...
  e("will-change-auto", [["will-change", "auto"]]), e("will-change-scroll", [["will-change", "scroll-position"]]), e("will-change-contents", [["will-change", "contents"]]), e("will-change-transform", [["will-change", "transform"]]), o("will-change", { themeKeys: [], handle: (i) => [l3("will-change", i)] }), e("content-none", [["--tw-content", "none"], ["content", "none"]]), o("content", { themeKeys: [], handle: (i) => [D2([$2("--tw-content", '""')]), l3("--tw-content", i), l3("content", "var(--tw-content)")] });
  {
    let i = "var(--tw-contain-size,) var(--tw-contain-layout,) var(--tw-contain-paint,) var(--tw-contain-style,)", u2 = () => D2([$2("--tw-contain-size"), $2("--tw-contain-layout"), $2("--tw-contain-paint"), $2("--tw-contain-style")]);
  ...
  {
    let i = () => D2([$2("--tw-outline-style", "solid")]);
    r.static("outline-hidden", () => [l3("outline-style", "none"), O2("@media", "(forced-colors: active)", [l3("outline", "2px solid transparent"), l3("outline-offset", "2px")])]), e("outline-none", [["--tw-outline-style", "none"], ["outline-style", "none"]]), e("outline-solid", [["--tw-outline-style", "solid"], ["outline-style", "solid"]]), e("outline-dashed", [["--tw-outline-style", "dashed"], ["outline-style", "dashed"]]), e("outline-dotted", [["--tw-outline-style", "dotted"], ["outline-style", "dotted"]]), e("outline-double", [["--tw-outline-style", "double"], ["outline-style", "double"]]), r.functional("outline", (u2) => {
      ...
      if (u2.value.kind === "arbitrary") {
        ...
        switch (u2.value.dataType ?? pe(m, ["color", "length", "number", "percentage"])) {
          ...
          default:
            return m = B2(m, u2.modifier, t), m === null ? void 0 : [l3("outline-color", m)];
        }
      }
      {
        ...
        switch (i.value.dataType ?? pe(u2, ["color", "length", "percentage", "absolute-size", "relative-size"])) {
          ...
          case "relative-size": {
            if (i.modifier) {
              ...
              if (!k2 && ue(i.modifier.value)) {
                let b2 = t.resolve(null, ["--spacing"]);
                if (!b2) return null;
                k2 = `calc(${b2} * ${i.modifier.value})`;
              }
              return !k2 && i.modifier.value === "none" && (k2 = "1"), k2 ? [l3("font-size", u2), l3("line-height", k2)] : null;
            }
            return [l3("font-size", u2)];
          }
          default:
            return u2 = B2(u2, i.modifier, t), u2 === null ? void 0 : [l3("color", u2)];
        }
      }
      {
      ...
      }
      {
        ...
        if (u2) {
          ...
          if (i.modifier) {
            ...
            if (!b2 && ue(i.modifier.value)) {
              let K2 = t.resolve(null, ["--spacing"]);
              if (!K2) return null;
              b2 = `calc(${K2} * ${i.modifier.value})`;
            }
            if (!b2 && i.modifier.value === "none" && (b2 = "1"), !b2) return null;
            let V2 = [l3("font-size", m)];
            return b2 && V2.push(l3("line-height", b2)), V2;
          }
    ...
    e("shadow-initial", [m, ["--tw-shadow-color", "initial"]]), r.functional("shadow", (C2) => {
      ...
      if (C2.value.kind === "arbitrary") {
        ...
        switch (C2.value.dataType ?? pe(A2, ["color"])) {
          case "color":
            return A2 = B2(A2, C2.modifier, t), A2 === null ? void 0 : [m(), l3("--tw-shadow-color", A2)];
          default:
            return [m(), l3("--tw-shadow", ne2(A2, (be) => `var(--tw-shadow-color, ${be})`)), l3("box-shadow", i)];
        }
      }
      ...
      if (C2.value.kind === "arbitrary") {
        ...
        switch (C2.value.dataType ?? pe(A2, ["color"])) {
          case "color":
            return A2 = B2(A2, C2.modifier, t), A2 === null ? void 0 : [m(), l3("--tw-inset-shadow-color", A2)];
          default:
            return [m(), l3("--tw-inset-shadow", `inset ${ne2(A2, (be) => `var(--tw-inset-shadow-color, ${be})`)}`), l3("box-shadow", i)];
        }
      }
      switch (C2.value.value) {
        case "none":
    ...
    r.functional("ring", (C2) => {
      ...
      if (C2.value.kind === "arbitrary") {
        ...
        switch (C2.value.dataType ?? pe(A2, ["color", "length"])) {
          ...
          default:
            return A2 = B2(A2, C2.modifier, t), A2 === null ? void 0 : [l3("--tw-ring-color", A2)];
        }
      }
      {
      ...
      if (!C2.value) return C2.modifier ? void 0 : [m(), l3("--tw-inset-ring-shadow", V2("1px")), l3("box-shadow", i)];
      if (C2.value.kind === "arbitrary") {
        let A2 = C2.value.value;
        switch (C2.value.dataType ?? pe(A2, ["color", "length"])) {
          case "length":
            return C2.modifier ? void 0 : [m(), l3("--tw-inset-ring-shadow", V2(A2)), l3("box-shadow", i)];
          default:
            return A2 = B2(A2, C2.modifier, t), A2 === null ? void 0 : [l3("--tw-inset-ring-color", A2)];
        }
      }
      {
        let A2 = q2(C2, t, ["--ring-color", "--color"]);
      ...
      }
      {
        if (C2.modifier) return;
        let A2 = t.resolve(C2.value.value, ["--ring-width"]);
        if (A2 === null && p(C2.value.value) && (A2 = `${C2.value.value}px`), A2) return [m(), l3("--tw-inset-ring-shadow", V2(A2)), l3("box-shadow", i)];
      }
      ...
      if (C2.value) {
        if (C2.value.kind === "arbitrary") {
          ...
          switch (C2.value.dataType ?? pe(A2, ["color", "length"])) {
            ...
            default:
              return A2 = B2(A2, C2.modifier, t), A2 === null ? void 0 : [l3("--tw-ring-offset-color", A2)];
          }
        }
        {
  ...
  return _r.test(r) ? (n) => {
    ...
    j2(t.nodes, (s2) => {
      ...
      le(a, (c) => {
        ...
        c.nodes = L2(d2.join(","));
        for (let f3 of c.nodes) if (f3.kind === "word" && f3.value[0] === "-" && f3.value[1] === "-") {
          let p3 = f3.value.replace(/-\*.*$/g, "");
          c.value === "--value" ? e.add(p3) : c.value === "--modifier" && o.add(p3);
        }
      }), s2.value = W2(a);
    }), n.utilities.functional(r.slice(0, -2), (s2) => {
      let a = structuredClone(t), c = s2.value, d2 = s2.modifier;
      if (c === null) return;
      let f3 = false, p3 = false, g3 = false, h3 = false, y2 = /* @__PURE__ */ new Map(), w2 = false;
      if (j2([a], (v2, { parent: x, replaceWith: T2 }) => {
        if ((x == null ? void 0 : x.kind) !== "rule" && (x == null ? void 0 : x.kind) !== "at-rule" || v2.kind !== "declaration" || !v2.value) return;
        let N2 = L2(v2.value);
        (le(N2, (E2, { replaceWith: P2 }) => {
          if (E2.kind === "function") {
            if (E2.value === "--value") {
              f3 = true;
              let i = Nt(c, E2, n);
              return i ? (p3 = true, i.ratio ? w2 = true : y2.set(v2, x), P2(i.nodes), 1) : (f3 || (f3 = false), T2([]), 2);
            } else if (E2.value === "--modifier") {
              if (d2 === null) return T2([]), 1;
              g3 = true;
              let i = Nt(d2, E2, n);
              return i ? (h3 = true, P2(i.nodes), 1) : (g3 || (g3 = false), T2([]), 2);
            }
          }
        }) ?? 0) === 0 && (v2.value = W2(N2));
      }), f3 && !p3 || g3 && !h3 || w2 && h3 || d2 && !w2 && !h3) return null;
      if (w2) for (let [v2, x] of y2) {
        let T2 = x.nodes.indexOf(v2);
        T2 !== -1 && x.nodes.splice(T2, 1);
      }
      return a.nodes;
...
function Nt(t, r, n) {
  for (let e of r.nodes) if (t.kind === "named" && e.kind === "word" && e.value[0] === "-" && e.value[1] === "-") {
    ...
    if (o.endsWith("-*")) {
      ...
      let a = [s2.shift()], c = n.theme.resolveWith(t.value, a, s2);
      if (c) {
        let [, d2 = {}] = c;
        {
          let f3 = d2[s2.pop()];
...
var Ge = { "--alpha": Dr, "--spacing": Fr, "--theme": Ur, theme: Kt };
function Dr(t, r, ...n) {
...
var Et = new RegExp(Object.keys(Ge).map((t) => `${t}\\(`).join("|"));
function ae(t, r) {
  let n = 0;
  return j2(t, (e) => {
    if (e.kind === "declaration" && e.value && Et.test(e.value)) {
      n |= 8, e.value = Rt(e.value, r);
      return;
    }
    e.kind === "at-rule" && (e.name === "@media" || e.name === "@custom-media" || e.name === "@container" || e.name === "@supports") && Et.test(e.params) && (n |= 8, e.params = Rt(e.params, r));
  }), n;
}
function Rt(t, r) {
  let n = L2(t);
  return le(n, (e, { replaceWith: o }) => {
    if (e.kind === "function" && e.value in Ge) {
      let s2 = u(W2(e.nodes).trim(), ",").map((c) => c.trim()), a = Ge[e.value](r, ...s2);
      return o(L2(a));
    }
  }), W2(n);
}
...
function Pt(t) {
  ...
  return r.sort((n, e) => Re(n[0], e[0])), r;
}
function Ot(t) {
  let r = [];
  for (let [e, o] of t.variants.entries()) {
    let c = function({ value: d2, modifier: f3 } = {}) {
      let p3 = e;
      d2 && (p3 += s2 ? `-${d2}` : d2), f3 && (p3 += `/${f3}`);
      let g3 = t.parseVariant(p3);
      if (!g3) return [];
      let h3 = F2(".__placeholder__", []);
      if (se(h3, g3, t.variants) === null) return [];
      let y2 = [];
      return Se(h3.nodes, (w2, { path: v2 }) => {
        if (w2.kind !== "rule" && w2.kind !== "at-rule" || w2.nodes.length > 0) return;
        v2.sort((N2, R2) => {
          let E2 = N2.kind === "at-rule", P2 = R2.kind === "at-rule";
          return E2 && !P2 ? -1 : !E2 && P2 ? 1 : 0;
        });
        let x = v2.flatMap((N2) => N2.kind === "rule" ? N2.selector === "&" ? [] : [N2.selector] : N2.kind === "at-rule" ? [`${N2.name} ${N2.params}`] : []), T2 = "";
        for (let N2 = x.length - 1; N2 >= 0; N2--) T2 = T2 === "" ? x[N2] : `${x[N2]} { ${T2} }`;
        y2.push(T2);
      }), y2;
    };
    var n = c;
    if (o.kind === "arbitrary") continue;
    let s2 = e !== "@", a = t.variants.getCompletions(e);
    switch (o.kind) {
      case "static": {
        r.push({ name: e, values: a, isArbitrary: false, hasDash: s2, selectors: c });
        break;
      }
      case "functional": {
        r.push({ name: e, values: a, isArbitrary: true, hasDash: s2, selectors: c });
        break;
      }
      case "compound": {
        r.push({ name: e, values: a, isArbitrary: true, hasDash: s2, selectors: c });
...
var He = class {
  ...
  compare(r, n) {
    ...
    let c = r.value, d2 = n.value;
    return c === null ? -1 : d2 === null || c.kind === "arbitrary" && d2.kind !== "arbitrary" ? 1 : c.kind !== "arbitrary" && d2.kind === "arbitrary" || c.value < d2.value ? -1 : 1;
  }
  keys() {
  ...
  set(r, { kind: n, applyFn: e, compounds: o, compoundsWith: s2, order: a }) {
    ...
    c ? Object.assign(c, { kind: n, applyFn: e, compounds: o }) : (a === void 0 && (this.lastOrder = this.nextOrder(), a = this.lastOrder), this.variants.set(r, { kind: n, applyFn: e, order: a, compoundsWith: s2, compounds: o }));
  }
  nextOrder() {
...
function Dt(t) {
  ...
  n("*", [":is(& > *)"], { compounds: 0 }), n("**", [":is(& *)"], { compounds: 0 });
  function e(f3, p3) {
    return p3.map((g3) => {
      g3 = g3.trim();
      let h3 = u(g3, " ");
  ...
  r.compound("not", 3, (f3, p3) => {
    ...
    if (j2([f3], (h3, { path: y2 }) => {
      ...
      let w2 = [], v2 = [];
      for (let T2 of y2) T2.kind === "at-rule" ? w2.push(T2) : T2.kind === "rule" && v2.push(T2);
      if (w2.length > 1) return 2;
      if (v2.length > 1) return 2;
      let x = [];
      for (let T2 of v2) {
        let N2 = a(T2.selector);
        if (!N2) return g3 = false, 2;
        x.push(F2(N2, []));
      }
      for (let T2 of w2) {
        let N2 = s2(T2);
    ...
    if (j2([f3], (y2, { path: w2 }) => {
      ...
      let v2 = y2.selector.replaceAll("&", g3);
      u(v2, ",").length > 1 && (v2 = `:is(${v2})`), y2.selector = `&:is(${v2} *)`, h3 = true;
    }), !h3) return null;
  ...
  {
    let f3 = function() {
      return D2([O2("@property", "--tw-content", [l3("syntax", '"*"'), l3("initial-value", '""'), l3("inherits", "false")])]);
    };
    var c = f3;
    r.static("before", (p3) => {
  ...
  n("first", ["&:first-child"]), n("last", ["&:last-child"]), n("only", ["&:only-child"]), n("odd", ["&:nth-child(odd)"]), n("even", ["&:nth-child(even)"]), n("first-of-type", ["&:first-of-type"]), n("last-of-type", ["&:last-of-type"]), n("only-of-type", ["&:only-of-type"]), n("visited", ["&:visited"]), n("target", ["&:target"]), n("open", ["&:is([open], :popover-open, :open)"]), n("default", ["&:default"]), n("checked", ["&:checked"]), n("indeterminate", ["&:indeterminate"]), n("placeholder-shown", ["&:placeholder-shown"]), n("autofill", ["&:autofill"]), n("optional", ["&:optional"]), n("required", ["&:required"]), n("valid", ["&:valid"]), n("invalid", ["&:invalid"]), n("in-range", ["&:in-range"]), n("out-of-range", ["&:out-of-range"]), n("read-only", ["&:read-only"]), n("empty", ["&:empty"]), n("focus-within", ["&:focus-within"]), r.static("hover", (f3) => {
    ...
    p3.value.kind === "arbitrary" ? f3.nodes = [F2(`&[aria-${_t(p3.value.value)}]`, f3.nodes)] : f3.nodes = [F2(`&[aria-${p3.value.value}="true"]`, f3.nodes)];
  }), r.suggest("aria", () => ["busy", "checked", "disabled", "expanded", "hidden", "pressed", "readonly", "required", "selected"]), r.functional("data", (f3, p3) => {
    if (!p3.value || p3.modifier) return null;
    f3.nodes = [F2(`&[data-${_t(p3.value.value)}]`, f3.nodes)];
  ...
  }, { compounds: 1 }), n("motion-safe", ["@media (prefers-reduced-motion: no-preference)"]), n("motion-reduce", ["@media (prefers-reduced-motion: reduce)"]), n("contrast-more", ["@media (prefers-contrast: more)"]), n("contrast-less", ["@media (prefers-contrast: less)"]);
  {
    let f3 = function(p3, g3, h3, y2) {
      ...
      let v2 = y2.get(g3);
      return v2 === null ? h3 === "asc" ? 1 : -1 : re2(w2, v2, h3);
    };
    var d2 = f3;
    {
    ...
    }
    {
      ...
      }, (h3, y2) => f3(h3, y2, "asc", g3)), r.suggest("@min", () => Array.from(p3.keys()).filter((h3) => h3 !== null)), r.suggest("@", () => Array.from(p3.keys()).filter((h3) => h3 !== null));
    }
  }
...
function Ye(t, r) {
  j2(t, (n, { replaceWith: e }) => {
    ...
    else if (n.kind === "at-rule" && (n.name === "@keyframes" || n.name === "@property")) return Object.assign(n, D2([O2(n.name, n.params, n.nodes)])), 1;
  });
}
function Ft(t) {
  let r = Tt(t), n = Dt(t), e = new z2((c) => Ct(c, a)), o = new z2((c) => Array.from(At(c, a))), s2 = new z2((c) => Ut(c, a)), a = { theme: t, utilities: r, variants: n, invalidCandidates: /* @__PURE__ */ new Set(), important: false, candidatesToCss(c) {
    let d2 = [];
    for (let f3 of c) {
    ...
    for (let p3 of d2) {
      ...
      if (g3.length !== 0) {
        ...
        for (let { node: h3, propertySort: y2 } of g3) {
          let w2 = 0n;
          for (let v2 of p3.variants) w2 |= 1n << BigInt(a.get(v2));
          e.set(h3, { properties: y2, variants: w2, candidate: c }), o.push(h3);
        }
      }
    }
    f3 || (n == null ? void 0 : n(c));
  }
  return o.sort((c, d2) => {
    let f3 = e.get(c), p3 = e.get(d2);
    ...
    return (f3.properties[g3] ?? 1 / 0) - (p3.properties[g3] ?? 1 / 0) || p3.properties.length - f3.properties.length || Re(f3.candidate, p3.candidate);
...
function Ut(t, r) {
  ...
  for (let s2 of n) {
    let a = Mr(s2);
    (t.important || r.important) && zt(s2);
    let c = { kind: "rule", selector: o, nodes: s2 };
    for (let d2 of t.variants) if (se(c, d2, r.variants) === null) return [];
...
function zr(t, r) {
  if (t.kind === "arbitrary") {
    let a = t.value;
    return t.modifier && (a = B2(a, t.modifier, r.theme)), a === null ? [] : [[l3(t.property, a)]];
  }
  let n = r.utilities.get(t.root) ?? [], e = [], o = n.filter((a) => !It(a));
  for (let a of o) {
...
function zt(t) {
  for (let r of t) r.kind !== "at-root" && (r.kind === "declaration" ? r.important = true : (r.kind === "rule" || r.kind === "at-rule") && zt(r.nodes));
}
function Mr(t) {
  ...
  for (; n.length > 0; ) {
    ...
    if (e.kind === "declaration") {
      if (e.property === "--tw-sort") {
        let s2 = Ze.indexOf(e.value ?? "");
        if (s2 !== -1) {
          r.add(s2);
          break;
        }
      }
      let o = Ze.indexOf(e.property);
      o !== -1 && r.add(o);
  ...
  j2([e], (g3, { parent: h3 }) => {
    if (g3.kind === "at-rule") {
      ...
      if (g3.name === "@utility") {
        ...
        a.get(y2).add(g3), j2(g3.nodes, (w2) => {
          if (!(w2.kind !== "at-rule" || w2.name !== "@apply")) {
            o.add(g3);
            for (let v2 of Mt(w2, r)) s2.get(g3).add(v2);
          }
        });
        return;
      }
      if (g3.name === "@apply") {
        if (h3 === null) return;
        n |= 1, o.add(h3);
        for (let y2 of Mt(g3, r)) s2.get(h3).add(y2);
      }
    }
  });
  let c = /* @__PURE__ */ new Set(), d2 = [], f3 = /* @__PURE__ */ new Set();
  function p3(g3, h3 = []) {
    if (!c.has(g3)) {
      if (f3.has(g3)) {
        ...
        throw g3.kind === "at-rule" && g3.name === "@utility" && y2.kind === "at-rule" && y2.name === "@utility" && j2(g3.nodes, (w2) => {
          ...
          for (let x of v2) for (let T2 of r.parseCandidate(x)) switch (T2.kind) {
            case "arbitrary":
              break;
            case "static":
            case "functional":
              if (y2.params.replace(/-\*$/, "") === T2.root) throw new Error(`You cannot \`@apply\` the \`${x}\` utility here because it creates a circular dependency.`);
              break;
            default:
          }
...
${J2([y2])}`);
      ...
      c.add(g3), f3.delete(g3), d2.push(g3);
    }
  }
  ...
  return j2(d2, (g3, { replaceWith: h3 }) => {
    ...
    let y2 = g3.params.split(/\s+/g);
    {
      ...
      for (let x of w2) if (x.kind === "rule") for (let T2 of x.nodes) v2.push(T2);
      else v2.push(x);
      h3(v2);
    }
  }), n;
...
async function Qe(t, r, n, e = 0) {
  let o = 0, s2 = [];
  return j2(t, (a, { replaceWith: c }) => {
    if (a.kind === "at-rule" && (a.name === "@import" || a.name === "@reference")) {
      let d2 = Lr(L2(a.params));
      if (d2 === null) return;
      ...
      return s2.push((async () => {
        ...
        let w2 = await n(f3, r), v2 = X2(w2.content);
        await Qe(v2, w2.base, n, e + 1), y2.nodes = Br([ee2({ base: w2.base }, v2)], p3, g3, h3);
      })()), c(y2), 1;
    }
...
function Pe(t) {
  ...
  for (let r of t) if (!qr.test(r)) return null;
...
function ye2(t, r, n, e = []) {
  for (let o of r) if (o != null) for (let s2 of Reflect.ownKeys(o)) {
    e.push(s2);
    let a = n(t[s2], o[s2], e);
    a !== void 0 ? t[s2] = a : !fe(t[s2]) || !fe(o[s2]) ? t[s2] = o[s2] : t[s2] = ye2({}, [t[s2], o[s2]], n, e), e.pop();
  }
  return t;
}
function je(t, r, n) {
  return function(o, s2) {
    ...
    let d2 = (() => {
      var _a2;
      let f3 = Oe(o), [p3, g3] = Hr(t.theme, f3), h3 = n(qt(r() ?? {}, f3) ?? null);
      ...
      if (h3 !== null && typeof h3 == "object" && !Array.isArray(h3)) {
        let y2 = ye2({}, [h3], (w2, v2) => v2);
        if (p3 === null && Object.hasOwn(h3, "__CSS_VALUES__")) {
          let w2 = {};
          for (let v2 in h3.__CSS_VALUES__) w2[v2] = h3[v2], delete y2[v2];
          p3 = w2;
        }
        for (let w2 in p3) w2 !== "__CSS_VALUES__" && (((_a2 = h3 == null ? void 0 : h3.__CSS_VALUES__) == null ? void 0 : _a2[w2]) & 4 && qt(y2, w2.split("-")) !== void 0 || (y2[v(w2)] = p3[w2]));
        return y2;
      }
      if (Array.isArray(p3) && Array.isArray(g3) && Array.isArray(h3)) {
        let y2 = p3[0], w2 = p3[1];
        g3[0] & 4 && (y2 = h3[0] ?? y2);
        for (let v2 of Object.keys(w2)) g3[1][v2] & 4 && (w2[v2] = h3[1][v2] ?? w2[v2]);
        return [y2, w2];
      }
      return p3 ?? h3;
    })();
    return c && typeof d2 == "string" && (d2 = G2(d2, c)), d2 ?? s2;
  };
}
function Hr(t, r) {
  if (r.length === 1 && r[0].startsWith("--")) return [t.get([r[0]]), t.getOptions(r[0])];
  let n = Pe(r), e = /* @__PURE__ */ new Map(), o = new z2(() => /* @__PURE__ */ new Map()), s2 = t.namespace(`--${n}`);
  ...
  for (let [p3, g3] of s2) {
    ...
    w2 = w2.replace(/-([a-z])/g, (v2, x) => x.toUpperCase()), o.get(y2 === "" ? null : y2).set(w2, [g3, t.getOptions(`--${n}${p3}`)]);
  }
  ...
  for (let [p3, g3] of o) {
    ...
    let y2 = {}, w2 = {};
    for (let [v2, [x, T2]] of g3) y2[v2] = x, w2[v2] = T2;
    e.set(p3, [h3, y2]), a.set(p3, [c, w2]);
  }
  let d2 = {}, f3 = {};
  for (let [p3, g3] of e) Jt(d2, [p3 ?? "DEFAULT"], g3);
  for (let [p3, g3] of a) Jt(f3, [p3 ?? "DEFAULT"], g3);
...
function _e(t, r, n = null) {
  for (let e = 0; e < t.length; e++) {
    let o = t[e], s2 = r(o, { parent: n, replaceWith(a) {
      Array.isArray(a) ? a.length === 0 ? t.splice(e, 1) : a.length === 1 ? t[e] = a[0] : t.splice(e, 1, ...a) : t[e] = a, e--;
    } }) ?? 0;
    if (s2 === 2) return 2;
    if (s2 !== 1 && o.kind === "function" && _e(o.nodes, r, o) === 2) return 2;
  }
}
function De(t) {
  let r = "";
  ...
  for (let a = 0; a < t.length; a++) {
    ...
    switch (c) {
      ...
      case ir: {
        ...
        let d2 = a, f3 = a + 1;
        for (; f3 < t.length && (s2 = t.charCodeAt(f3), !(s2 !== Yt && s2 !== Zt && s2 !== Qt && s2 !== rr && s2 !== tr && s2 !== nr && s2 !== ir)); f3++) ;
        a = f3 - 1;
        let p3 = t.slice(d2, f3), g3 = p3.trim() === "," ? Qr(p3) : Yr(p3);
      ...
      case er: {
        ...
        if (o = "", d2.value !== ":not" && d2.value !== ":where" && d2.value !== ":has" && d2.value !== ":is") {
          ...
          let g3 = a;
          d2.nodes.push(Xr(t.slice(f3, g3))), o = "", a = g3, r.push(d2);
          break;
        }
      ...
      case rn: {
        let d2 = a;
        for (let f3 = a + 1; f3 < t.length; f3++) if (s2 = t.charCodeAt(f3), s2 === Gt) f3 += 1;
        else if (s2 === c) {
          a = f3;
          break;
        }
      ...
      case Gt: {
        ...
        o += String.fromCharCode(c) + String.fromCharCode(d2), a += 1;
        break;
      }
      default:
        o += String.fromCharCode(c);
...
function et({ designSystem: t, ast: r, resolvedConfig: n, featuresRef: e, referenceMode: o }) {
  let s2 = { addBase(a) {
    if (o) return;
    let c = H2(a);
    e.current |= ae(c, t), r.push(O2("@layer", "base", c));
  }, addVariant(a, c) {
    if (!Ke.test(a)) throw new Error(`\`addVariant('${a}')\` defines an invalid variant name. Variants should only contain alphanumeric, dashes or underscore characters.`);
    typeof c == "string" || Array.isArray(c) ? t.variants.static(a, (d2) => {
      d2.nodes = lr(c, d2.nodes);
    }, { compounds: ie2(typeof c == "string" ? [c] : c) }) : typeof c == "object" && t.variants.fromAst(a, H2(c));
  }, matchVariant(a, c, d2) {
    function f3(g3, h3, y2) {
      let w2 = c(g3, { modifier: (h3 == null ? void 0 : h3.value) ?? null });
      return lr(w2, y2);
    }
    ...
    t.variants.group(() => {
      ...
      let y2 = g3.value ? g3.value.value : "DEFAULT", w2 = h3.value ? h3.value.value : "DEFAULT", v2 = ((_a2 = d2 == null ? void 0 : d2.values) == null ? void 0 : _a2[y2]) ?? y2, x = ((_b = d2 == null ? void 0 : d2.values) == null ? void 0 : _b[w2]) ?? w2;
      if (d2 && typeof d2.sort == "function") return d2.sort({ value: v2, modifier: ((_c = g3.modifier) == null ? void 0 : _c.value) ?? null }, { value: x, modifier: ((_d = h3.modifier) == null ? void 0 : _d.value) ?? null });
      let T2 = p3.indexOf(y2), N2 = p3.indexOf(w2);
      return T2 = T2 === -1 ? p3.length : T2, N2 = N2 === -1 ? p3.length : N2, T2 !== N2 ? T2 - N2 : v2 < x ? -1 : 1;
    });
  }, addUtilities(a) {
    a = Array.isArray(a) ? a : [a];
    let c = a.flatMap((f3) => Object.entries(f3));
    c = c.flatMap(([f3, p3]) => u(f3, ",").map((g3) => [g3.trim(), p3]));
    let d2 = new z2(() => []);
    for (let [f3, p3] of c) {
      ...
      let g3 = Xe(f3), h3 = false;
      if (_e(g3, (y2) => {
        if (y2.kind === "selector" && y2.value[0] === "." && or.test(y2.value.slice(1))) {
          let w2 = y2.value;
          y2.value = "&";
          let v2 = De(g3), x = w2.slice(1), T2 = v2 === "&" ? H2(p3) : [M2(v2, H2(p3))];
          d2.get(x).push(...T2), h3 = true, y2.value = w2;
          return;
        }
    ...
    let d2 = (c == null ? void 0 : c.type) ? Array.isArray(c == null ? void 0 : c.type) ? c.type : [c.type] : ["any"];
    for (let [p3, g3] of Object.entries(a)) {
      let h3 = function({ negative: y2 }) {
        return (w2) => {
          ...
          let v2 = d2.includes("color"), x = null, T2 = false;
          {
            let E2 = (c == null ? void 0 : c.values) ?? {};
            v2 && (E2 = Object.assign({ inherit: "inherit", transparent: "transparent", current: "currentColor" }, E2)), w2.value ? w2.value.kind === "arbitrary" ? x = w2.value.value : w2.value.fraction && E2[w2.value.fraction] ? (x = E2[w2.value.fraction], T2 = true) : E2[w2.value.value] ? x = E2[w2.value.value] : E2.__BARE_VALUE__ && (x = E2.__BARE_VALUE__(w2.value) ?? null, T2 = (w2.value.fraction !== null && (x == null ? void 0 : x.includes("/"))) ?? false) : x = E2.DEFAULT ?? null;
          }
          if (x === null) return;
          let N2;
          {
            let E2 = (c == null ? void 0 : c.modifiers) ?? null;
            w2.modifier ? E2 === "any" || w2.modifier.kind === "arbitrary" ? N2 = w2.modifier.value : (E2 == null ? void 0 : E2[w2.modifier.value]) ? N2 = E2[w2.modifier.value] : v2 && !Number.isNaN(Number(w2.modifier.value)) ? N2 = `${w2.modifier.value}%` : N2 = null : N2 = null;
          }
          if (w2.modifier && N2 === null && !T2) return ((_b = w2.value) == null ? void 0 : _b.kind) === "arbitrary" ? null : void 0;
          v2 && N2 !== null && (x = G2(x, N2)), y2 && (x = `calc(${x} * -1)`);
          let R2 = H2(g3(x, { modifier: N2 }));
          return e.current |= ve(R2, t), R2;
        };
      };
      var f3 = h3;
      if (!or.test(p3)) throw new Error(`\`matchUtilities({ '${p3}' : … })\` defines an invalid utility name. Utilities should be alphanumeric and start with a lowercase letter, eg. \`scrollbar\`.`);
      (c == null ? void 0 : c.supportsNegativeValues) && t.utilities.functional(`-${p3}`, h3({ negative: true }), { types: d2 }), t.utilities.functional(p3, h3({ negative: false }), { types: d2 }), t.utilities.suggest(p3, () => {
        let y2 = (c == null ? void 0 : c.values) ?? {}, w2 = new Set(Object.keys(y2));
        w2.delete("__BARE_VALUE__"), w2.has("DEFAULT") && (w2.delete("DEFAULT"), w2.add(null));
        let v2 = (c == null ? void 0 : c.modifiers) ?? {}, x = v2 === "any" ? [] : Object.keys(v2);
        return [{ supportsNegative: (c == null ? void 0 : c.supportsNegativeValues) ?? false, values: Array.from(w2), modifiers: x }];
      });
    }
  }, addComponents(a, c) {
  ...
  }, theme: je(t, () => n.theme ?? {}, (a) => a), prefix(a) {
    return a;
  }, config(a, c) {
    let d2 = n;
    if (!a) return d2;
...
function H2(t) {
  ...
  for (let [e, o] of n) if (typeof o != "object") {
    if (!e.startsWith("--")) {
      if (o === "@slot") {
        r.push(M2(e, [O2("@slot")]));
        continue;
...
function ar(t, r, n) {
  for (let e of sn(r)) t.theme.addKeyframes(e);
}
function sn(t) {
  let r = [];
...
var un = { blocklist: [], future: {}, prefix: "", important: false, darkMode: null, theme: {}, plugins: [], content: { files: [] } };
function rt(t, r) {
  let n = { design: t, configs: [], plugins: [], content: { files: [] }, theme: {}, extend: {}, result: structuredClone(un) };
  for (let o of r) tt(n, o);
...
function tt(t, { config: r, base: n, path: e, reference: o }) {
  let s2 = [];
  ...
  for (let d2 of r.presets ?? []) tt(t, { path: e, base: n, config: d2, reference: o });
  for (let d2 of s2) t.plugins.push(d2), d2.config && tt(t, { path: e, base: n, config: d2.config, reference: !!d2.reference });
  let a = r.content ?? [], c = Array.isArray(a) ? a : a.files;
  for (let d2 of c) t.content.files.push(typeof d2 == "object" ? d2 : { base: n, pattern: d2 });
  t.configs.push(r);
}
function cn(t) {
  var _a2;
  let r = /* @__PURE__ */ new Set(), n = je(t.design, () => t.theme, o), e = Object.assign(n, { theme: n, colors: l });
  function o(s2) {
  ...
  for (let s2 of t.configs) {
    ...
    for (let d2 in c) (_a2 = t.extend)[d2] ?? (_a2[d2] = []), t.extend[d2].push(c[d2]);
  }
...
function dn({ center: t, padding: r, screens: n }, e) {
  let o = [], s2 = null;
  if (t && o.push(l3("margin-inline", "auto")), (typeof r == "string" || typeof r == "object" && r !== null && "DEFAULT" in r) && o.push(l3("padding-inline", typeof r == "string" ? r : r.DEFAULT)), typeof n == "object" && n !== null) {
    ...
    if (a.sort((c, d2) => re2(c[1], d2[1], "asc")), a.length > 0) {
      let [c] = a[0];
      o.push(O2("@media", `(width >= --theme(--breakpoint-${c}))`, [l3("max-width", "none")]));
    }
    for (let [c, d2] of Object.entries(n)) {
      if (typeof d2 == "object") if ("min" in d2) d2 = d2.min;
      else continue;
      s2.set(c, O2("@media", `(width >= ${d2})`, [l3("max-width", d2)]));
    }
  }
  if (typeof r == "object" && r !== null) {
    let a = Object.entries(r).filter(([c]) => c !== "DEFAULT").map(([c, d2]) => [c, e.theme.resolveValue(c, ["--breakpoint"]), d2]).filter(Boolean);
    a.sort((c, d2) => re2(c[1], d2[1], "asc"));
    for (let [c, , d2] of a) if (s2 && s2.has(c)) s2.get(c).nodes.push(l3("padding-inline", d2));
    else {
      if (s2) continue;
      o.push(O2("@media", `(width >= theme(--breakpoint-${c}))`, [l3("padding-inline", d2)]));
    }
  }
  if (s2) for (let [, a] of s2) o.push(a);
  return o;
}
function fr({ addVariant: t, config: r }) {
...
function dr(t, r) {
  ...
  for (let [a, c] of Object.entries(n)) {
    ...
    let p3 = true;
    typeof c == "string" && (p3 = false);
    let g3 = pn(c);
    p3 ? o.push(h3) : h3(e);
  }
  if (o.length !== 0) {
    for (let [, a] of r.variants.variants) a.order > e && (a.order += o.length);
    r.variants.compareFns = new Map(Array.from(r.variants.compareFns).map(([a, c]) => (a > e && (a += o.length), [a, c])));
...
function pr(t, r) {
  ...
  if (Object.keys(n).length > 0) {
    let s2 = r.variants.get("aria"), a = s2 == null ? void 0 : s2.applyFn, c = s2 == null ? void 0 : s2.compounds;
  ...
  if (Object.keys(e).length > 0) {
    let s2 = r.variants.get("supports"), a = s2 == null ? void 0 : s2.applyFn, c = s2 == null ? void 0 : s2.compounds;
  ...
  if (Object.keys(o).length > 0) {
    let s2 = r.variants.get("data"), a = s2 == null ? void 0 : s2.applyFn, c = s2 == null ? void 0 : s2.compounds;
...
var gn = /^[a-z]+$/;
async function mr({ designSystem: t, base: r, ast: n, loadModule: e, globs: o }) {
  let s2 = 0, a = [], c = [];
  j2(n, (g3, { parent: h3, replaceWith: y2, context: w2 }) => {
    if (g3.kind === "at-rule") {
      if (g3.name === "@plugin") {
        if (h3 !== null) throw new Error("`@plugin` cannot be nested.");
        let v2 = g3.params.slice(1, -1);
        if (v2.length === 0) throw new Error("`@plugin` must have a path.");
        let x = {};
        for (let T2 of g3.nodes ?? []) {
          if (T2.kind !== "declaration") throw new Error(`Unexpected \`@plugin\` option:

${J2([T2])}

\`@plugin\` options must be a flat list of declarations.`);
          if (T2.value === void 0) continue;
          let N2 = T2.value, R2 = u(N2, ",").map((E2) => {
            ...
            if (Number.isNaN(Number(E2))) {
              ...
              if (E2[0] === "{" && E2[E2.length - 1] === "}") throw new Error(`Unexpected \`@plugin\` option: Value of declaration \`${J2([T2]).trim()}\` is not supported.

Using an object as a plugin option is currently only supported in JavaScript configuration files.`);
            } else return Number(E2);
            return E2;
          });
          x[T2.property] = R2.length === 1 ? R2[0] : R2;
        }
        a.push([{ id: v2, base: w2.base, reference: !!w2.reference }, Object.keys(x).length > 0 ? x : null]), y2([]), s2 |= 4;
        return;
      }
      if (g3.name === "@config") {
        if (g3.nodes.length > 0) throw new Error("`@config` cannot have a body.");
        if (h3 !== null) throw new Error("`@config` cannot be nested.");
        c.push({ id: g3.params.slice(1, -1), base: w2.base, reference: !!w2.reference }), y2([]), s2 |= 4;
        return;
      }
    }
  }), cr(t);
  ...
  if (t.resolveThemeValue = function(h3) {
    return h3.startsWith("--") ? d2(h3) : (s2 |= gr({ designSystem: t, base: r, ast: n, globs: o, configs: [], pluginDetails: [] }), t.resolveThemeValue(h3));
  }, !a.length && !c.length) return 0;
  let [f3, p3] = await Promise.all([Promise.all(c.map(async ({ id: g3, base: h3, reference: y2 }) => {
    ...
    let v2 = await e(g3, h3, "plugin");
    return { path: g3, base: v2.base, plugin: v2.module, options: w2, reference: y2 };
  }))]);
  return s2 |= gr({ designSystem: t, base: r, ast: n, globs: o, configs: f3, pluginDetails: p3 }), s2;
}
function gr({ designSystem: t, base: r, ast: n, globs: e, configs: o, pluginDetails: s2 }) {
  let a = 0, d2 = [...s2.map((v2) => {
  ...
  }), ...o], { resolvedConfig: f3 } = rt(t, [{ config: sr(t.theme), base: r, reference: true }, ...d2, { config: { plugins: [fr] }, base: r, reference: true }]), { resolvedConfig: p3, replacedThemeKeys: g3 } = rt(t, d2);
  t.resolveThemeValue = function(x, T2) {
    let N2 = y2.theme(x, T2);
    if (Array.isArray(N2) && N2.length === 2) return N2[0];
    if (Array.isArray(N2)) return N2.join(", ");
    if (typeof N2 == "string") return N2;
  };
  let h3 = { designSystem: t, ast: n, resolvedConfig: f3, featuresRef: { set current(v2) {
    a |= v2;
  } } }, y2 = et({ ...h3, referenceMode: false }), w2;
  for (let { handler: v2, reference: x } of f3.plugins) x ? (w2 || (w2 = et({ ...h3, referenceMode: true })), v2(w2)) : v2(y2);
  if (Bt(t, p3, g3), ar(t, p3, g3), pr(p3, t), dr(p3, t), ur(p3, t), !t.theme.prefix && f3.prefix) {
    if (f3.prefix.endsWith("-") && (f3.prefix = f3.prefix.slice(0, -1), console.warn(`The prefix "${f3.prefix}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only and is written as a variant before all utilities. We have fixed up the prefix for you. Remove the trailing \`-\` to silence this warning.`)), !gn.test(f3.prefix)) throw new Error(`The prefix "${f3.prefix}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only.`);
    t.theme.prefix = f3.prefix;
  }
  if (!t.important && f3.important === true && (t.important = true), typeof f3.important == "string") {
    let v2 = f3.important;
    j2(n, (x, { replaceWith: T2, parent: N2 }) => {
      if (x.kind === "at-rule" && !(x.name !== "@tailwind" || x.params !== "utilities")) return (N2 == null ? void 0 : N2.kind) === "rule" && N2.selector === v2 ? 2 : (T2(F2(v2, [x])), 2);
    });
  }
  for (let v2 of f3.blocklist) t.invalidCandidates.add(v2);
  for (let v2 of f3.content.files) {
...
async function hr(t, { base: r = "", loadModule: n = hn, loadStylesheet: e = vn } = {}) {
  let o = 0;
  t = [ee2({ base: r }, t)], o |= await Qe(t, r, e);
  let s2 = null, a = new g2(), c = [], d2 = [], f3 = null, p3 = null, g3 = [], h3 = [], y2 = null;
  j2(t, (v2, { parent: x, replaceWith: T2, context: N2 }) => {
    if (v2.kind === "at-rule") {
      if (v2.name === "@tailwind" && (v2.params === "utilities" || v2.params.startsWith("utilities"))) {
        ...
        for (let E2 of R2) if (E2.startsWith("source(")) {
          ...
          y2 = { base: N2.sourceBase ?? N2.base, pattern: P2.slice(1, -1) };
        }
        p3 = v2, o |= 16;
      }
      if (v2.name === "@utility") {
        ...
        let R2 = St(v2);
        if (R2 === null) throw new Error(`\`@utility ${v2.params}\` defines an invalid utility name. Utilities should be alphanumeric and start with a lowercase letter.`);
        d2.push(R2);
      }
      if (v2.name === "@source") {
        ...
        h3.push({ base: N2.base, pattern: R2.slice(1, -1) }), T2([]);
        return;
      }
      if (v2.name === "@variant" && (x === null ? v2.nodes.length === 0 ? v2.name = "@custom-variant" : (j2(v2.nodes, (R2) => {
        if (R2.kind === "at-rule" && R2.name === "@slot") return v2.name = "@custom-variant", 2;
      }), v2.name === "@variant" && g3.push(v2)) : g3.push(v2)), v2.name === "@custom-variant") {
        if (x !== null) throw new Error("`@custom-variant` cannot be nested.");
        T2([]);
        let [R2, E2] = u(v2.params, " ");
        if (!Ke.test(R2)) throw new Error(`\`@custom-variant ${R2}\` defines an invalid variant name. Variants should only contain alphanumeric, dashes or underscore characters.`);
        if (v2.nodes.length > 0 && E2) throw new Error(`\`@custom-variant ${R2}\` cannot have both a selector and a body.`);
        if (v2.nodes.length === 0) {
          if (!E2) throw new Error(`\`@custom-variant ${R2}\` has no selector or body.`);
          let P2 = u(E2.slice(1, -1), ",");
          if (P2.length === 0 || P2.some((m) => m.trim() === "")) throw new Error(`\`@custom-variant ${R2} (${P2.join(",")})\` selector is invalid.`);
          let i = [], u2 = [];
          ...
          c.push((m) => {
            m.variants.static(R2, (k2) => {
              ...
              for (let V2 of i) b2.push(M2(V2, k2.nodes));
              k2.nodes = b2;
            }, { compounds: ie2([...u2, ...i]) });
          });
          return;
          ...
          c.push((P2) => {
            P2.variants.fromAst(R2, v2.nodes);
          });
          return;
        }
      }
      if (v2.name === "@media") {
        let R2 = u(v2.params, " "), E2 = [];
        for (let P2 of R2) if (P2.startsWith("source(")) {
          let i = P2.slice(7, -1);
          j2(v2.nodes, (u2, { replaceWith: m }) => {
            if (u2.kind === "at-rule" && u2.name === "@tailwind" && u2.params === "utilities") return u2.params += ` source(${i})`, m([ee2({ sourceBase: N2.base }, [u2])]), 2;
          });
        ...
        } else P2 === "important" ? s2 = true : P2 === "reference" ? v2.nodes = [ee2({ reference: true }, v2.nodes)] : E2.push(P2);
        return E2.length > 0 ? v2.params = E2.join(" ") : R2.length > 0 && T2(v2.nodes), j2(v2.nodes, (P2) => {
          P2.kind === "at-rule" && P2.name === "@variant" && g3.push(P2);
        }), 1;
      }
      if (v2.name === "@theme") {
        let [R2, E2] = yn(v2.params);
        if (N2.reference && (R2 |= 2), E2) {
          if (!mn.test(E2)) throw new Error(`The prefix "${E2}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only.`);
          a.prefix = E2;
        }
        return j2(v2.nodes, (P2, { replaceWith: i }) => {
          if (P2.kind === "at-rule" && P2.name === "@keyframes") return R2 & 2 ? (i([]), 1) : (a.addKeyframes(P2), i([]), 1);
          if (P2.kind === "comment") return;
          if (P2.kind === "declaration" && P2.property.startsWith("--")) {
            a.add(v(P2.property), P2.value ?? "", R2);
            return;
          }
          let u2 = J2([O2(v2.name, v2.params, [P2])]).split(`
`).map((m, k2, b2) => `${k2 === 0 || k2 >= b2.length - 2 ? " " : ">"} ${m}`).join(`
`);
          throw new Error(`\`@theme\` blocks must only contain custom properties or \`@keyframes\`.

${u2}`);
        }), !f3 && !(R2 & 2) ? (f3 = F2(":root, :host", v2.nodes), T2([f3])) : T2([]), 1;
      }
    }
  });
  let w2 = Ft(a);
  s2 && (w2.important = s2), o |= await mr({ designSystem: w2, base: r, ast: t, loadModule: n, globs: h3 });
  for (let v2 of c) v2(w2);
  for (let v2 of d2) v2(w2);
  if (f3) {
    let v2 = [];
    for (let [T2, N2] of a.entries()) N2.options & 2 || v2.push(l3(f2(T2), N2.value));
    let x = a.getKeyframes();
    if (x.length > 0) {
      let T2 = [...a.namespace("--animate").values()].flatMap((N2) => N2.split(" "));
      for (let N2 of x) {
        let R2 = N2.params;
        T2.includes(R2) && v2.push(D2([N2]));
      }
    }
    f3.nodes = v2;
  }
  ...
  if (g3.length > 0) {
    for (let v2 of g3) {
      let x = F2("&", v2.nodes), T2 = v2.params, N2 = w2.parseVariant(T2);
      if (N2 === null) throw new Error(`Cannot use \`@variant\` with unknown variant: ${T2}`);
      if (se(x, N2, w2.variants) === null) throw new Error(`Cannot use \`@variant\` with variant: ${T2}`);
      Object.assign(v2, x);
    }
    o |= 32;
  }
  return o |= ae(t, w2), o |= ve(t, w2), j2(t, (v2, { replaceWith: x }) => {
    if (v2.kind === "at-rule") return v2.name === "@utility" && x([]), 1;
  }), { designSystem: w2, ast: t, globs: h3, root: y2, utilitiesNode: p3, features: o };
}
async function wn(t, r = {}) {
  let { designSystem: n, ast: e, globs: o, root: s2, utilitiesNode: a, features: c } = await hr(t, r);
  e.unshift(Te(`! tailwindcss v${at} | MIT License | https://tailwindcss.com `));
  function d2(h3) {
    n.invalidCandidates.add(h3);
  }
  let f3 = /* @__PURE__ */ new Set(), p3 = null, g3 = 0;
  return { globs: o, root: s2, features: c, build(h3) {
    if (c === 0) return t;
    ...
    let v2 = Z2(f3, n, { onInvalidCandidate: d2 }).astNodes;
    return g3 === v2.length ? (p3 ?? (p3 = te2(e)), p3) : (g3 = v2.length, a.nodes = v2, p3 = te2(e), p3);
  } };
}
async function tl(t, r = {}) {
  let n = X2(t), e = await wn(n, r), o = n, s2 = t;
  return { ...e, build(a) {
    let c = e.build(a);
    return c === o || (s2 = J2(c), o = c), s2;
  } };
}
async function rl(t, r = {}) {
  return (await hr(X2(t), r)).designSystem;
}
function bn() {
...
export {
  me as Features,
  rl as __unstable__loadDesignSystem,
  tl as compile,
  wn as compileAst,
  bn as default
};
